...
/**
 * Computes the Multivariate Gaussian probability.
 * @param (sig_x,sig_y) standard deviation in the x and y directions
 * @param (x_obs,y_obs) x and y values of sensor reading
 * @param (mu_x,mu_y) x and y coordinates of associated landmark
 * @output Weight of the particle
 */
